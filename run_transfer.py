...
import torch
from exp import exp_ETA, exp_Transfer
import time
import logging
...
Exp_dict = {
            'Gpt_prompt': exp_Transfer.Exp_Gpt_prompt,
            'LightPath':exp_Transfer.Exp_LightPath,
            'PathRank':exp_Transfer.Exp_PathRank,
            'HMTRL':exp_Transfer.Exp_HMTRL,
            'Trembr':exp_Transfer.Exp_Trembr,
            'START':exp_Transfer.Exp_START
        }
...
# mon_day = "0421"
# min_sec = '2200'
# setting = '{}_{}_{}_bts{}_concat(node+text)_shiyan'.format(
#         mon_day,
#         min_sec,
#         args.data_name,
#         args.batch_size,
